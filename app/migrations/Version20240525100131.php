 ...
 */
final class Version20240525100131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE elements CHANGE title title VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE elements CHANGE title title VARCHAR(64) NOT NULL');
    }
}
